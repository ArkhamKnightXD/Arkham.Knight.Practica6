...
import arkham.knight.practica6.Main;
import arkham.knight.practica6.Modelos.*;
import arkham.knight.practica6.Servicios.*;
...
public class Enrutamiento {
    ...
    public static void crearRutas() {
        ...
        webSocket("/chat", ServicioWebSocket.class);
        init();
        ...
        get("/inicio", (req, res) -> {
            ...
            List<Usuario> usuariosPrivilegiados = ServicioUsuario.getInstancia().encontrarUsuariosPrivilegiados();
        ...
        get("/super-chat/:usuario", (req, res) -> {
            ...
            for(Map.Entry<String, Pair<org.eclipse.jetty.websocket.api.Session, String>> usuarios : ServicioWebSocket.usuariosConectados.entrySet()) {
